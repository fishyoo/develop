...
alias gpla='
myPath=$PWD;
echo 【1】-----------------------------------;cd /cygdrive/d/fishing/; pwd; gpl; echo;
echo 【2】-----------------------------------;cd /cygdrive/d/cc/; pwd; gpl; echo; 
cd $myPath'

alias gsta='
myPath=$PWD;
echo 【1】-----------------------------------;cd /cygdrive/d/fishing/; pwd; gst; echo;   
echo 【2】-----------------------------------;cd /cygdrive/d/cc/; pwd; gst; echo;
cd $myPath'


alias gca='
myPath=$PWD;
echo 【1】-----------------------------------;cd /cygdrive/d/fishing/; pwd; gad; gc.; sleep 1; echo;
echo 【2】-----------------------------------;cd /cygdrive/d/cc/; pwd; gad; gc.; sleep 1; echo; 
cd $myPath'


alias gpsa='
myPath=$PWD;
echo 【1】-----------------------------------;cd /cygdrive/d/fishing/; pwd; gps; sleep 1; echo;
echo 【2】-----------------------------------;cd /cygdrive/d/cc/; pwd; gps; sleep 1; echo; 
cd $myPath'
